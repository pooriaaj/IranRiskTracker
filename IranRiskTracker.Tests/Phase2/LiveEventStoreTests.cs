...
namespace IranRiskTracker.Tests.Phase2
{
    public class LiveEventStoreTests
    {
        ...
        public void AcceptLiveEvent_StoresEvent()
        {
            ...
            var req = new LiveEventCreateRequest { Title = "t1", RawContent = "r", OccurredAt = DateTime.UtcNow, Category = Domain.Enums.EventCategory.Unknown, Urgency = Domain.Enums.UrgencyLevel.Low };
        ...
        public void GetLiveEvents_ReturnsSubmittedEvents_NewestFirst()
        {
            ...
            var a = sut.AcceptLiveEvent(new LiveEventCreateRequest { Title = "a", RawContent = "r", OccurredAt = DateTime.UtcNow.AddMinutes(-5), Category = Domain.Enums.EventCategory.Unknown, Urgency = Domain.Enums.UrgencyLevel.Low });
            System.Threading.Thread.Sleep(5);
            var b = sut.AcceptLiveEvent(new LiveEventCreateRequest { Title = "b", RawContent = "r", OccurredAt = DateTime.UtcNow, Category = Domain.Enums.EventCategory.Unknown, Urgency = Domain.Enums.UrgencyLevel.Low });
        ...
        public void EventsController_DelegatesToService_ForLiveEndpoints()
        {
            ...
            var resPost = controller.PostLive(new LiveEventCreateRequest { Title = "x", RawContent = "r", OccurredAt = DateTime.UtcNow, Category = Domain.Enums.EventCategory.Unknown, Urgency = Domain.Enums.UrgencyLevel.Low });
